	...
	<div class="col-md-12">
		...
		<p>
			<ul class="nav nav-tabs">
				<li class="active"><a href="#"><?php echo $pluralHumanName;?></a></li>
...
<div class="row">
	<div class="col-md-12">
		...
		'format' => __('Página {:page} de {:pages}, mostrando {:current} imagens de um total de {:count}, começando em {:start}, terminando em {:end}')
		));
		?>"; ?>
		</p>
		<ul class="pagination">
			<?php
				echo "<?php\n";
				echo "\t\techo \$this->Paginator->prev('«', array('tag' => 'li'), '<a href=\"\">«</a>', array('tag' => 'li','class' => 'disabled', 'escape'=>false));\n";
				echo "\t\techo \$this->Paginator->numbers(array('separator' => '','tag' => 'li','currentClass'=>'active','currentTag'=>'a'));\n";
				echo "\t\techo \$this->Paginator->next('»', array('tag' => 'li'), '<a href=\"\">»</a>', array('tag' => 'li','class' => 'disabled', 'escape'=>false));\n";
				echo "\t?>\n";
			?>
		</ul>
	</div>
